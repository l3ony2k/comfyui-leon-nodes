...
# Tuzi API GPT Image Generation Node
class Leon_Tuzi_GPT_Image_API_Node(HyprLabImageGenerationNodeBase):
    CATEGORY = "Leon_API"
    RETURN_TYPES = ("IMAGE", "STRING", "INT")
    RETURN_NAMES = ("image", "image_url", "seed")
    FUNCTION = "generate_tuzi_gpt_image"
    SIZE_CHOICES = [
        "auto",
        "1024x1024",
        "1536x1024",
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "prompt": ("STRING", {"multiline": True, "default": "A cute cat.", "tooltip": "Text description of the desired image."}),
                "model": (["gpt-image-2", "gpt-image-1.5", "gpt-image-1", "gpt-4o-image-vip", "gpt-4o-image"], {"default": "gpt-image-2"}),
                "size": (cls.SIZE_CHOICES, {"default": "auto", "tooltip": "Size of the generated image"}),
                "seed": ("INT", {"default": 0, "min": 0, "max": 0xffffffffffffffff, "tooltip": "Random seed for reproducible results"}),
                "api_key": ("STRING", {"multiline": False, "default": "YOUR_API_KEY_HERE", "tooltip": "Your Tuzi API key"}),
                "response_format": (["url", "b64_json"], {"default": "url", "tooltip": "Format for returning the generated image. Must be either url or b64_json."}),
            },
    ...
    def generate_tuzi_gpt_image(
        ...
        image_inputs = []
        if input_images_array is not None and isinstance(input_images_array, list):
            image_inputs = input_images_array

        # Set image in payload
...
TUZI_NODE_CLASS_MAPPINGS = {
    ...
    "Leon_Tuzi_GPT_Image_API_Node": Leon_Tuzi_GPT_Image_API_Node,
}

TUZI_NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "Leon_Tuzi_GPT_Image_API_Node": "🤖 Leon Tuzi GPT-Image API 🐰",
}
